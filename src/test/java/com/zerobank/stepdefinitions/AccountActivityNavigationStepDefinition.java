...
public class AccountActivityNavigationStepDefinition {
    ...
    accountActivityNavigationPage.savingsSelected();
    ...
    public void account_drop_down_should_have_Checking_selected() {
        accountActivityNavigationPage.checkingSelected();

    }

    @When("the user clicks on Credit card link on the Account Summary page")
    public void the_user_clicks_on_Credit_card_link_on_the_Account_Summary_page() {
    accountActivityNavigationPage.clickCreditCard();
    }
    ...
    accountActivityNavigationPage.creditCardSelected();
    }
